<!-- Modal Barra -->
<div class="modal fade" id="miModalBarra" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-8 p-0 centrar-custom">
                                <progress id="barra_de_progreso" value="50" max="100"></progress>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer p-1 border-0 align-self-center">
                <button class="btn btn-success p-1 m-1" id="cerrarBarra" data-dismiss="modal" aria-label="Close" style="width:65px;">Aceptar</button>
            </div>
        </div>
    </div>
</div>
