...
<div class="modal fade" id="miModalBuscar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">Lista de Alumnos .°.</div>
            <div class="modal-body" style="overflow:hidden;">
                ...
                <div class="form-control form-control-sm my-1" style="border-width:5px;height:300px;overflow:auto;">
                    ...
                    <table class="table responsive table-sm table-hover border border-black m-0 table-bordered" style="font-size:13px;">
                        <thead>
                            <tr>
                        ...
                        <tbody id="contenido">
                            ...
                            $consulta = $funcion -> Seleccionar("SELECT cod_alumno, paterno, materno, nombres FROM alumno ORDER BY paterno, materno, nombres");
...
<div class="modal fade" id="miModalBuscarDocente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">Lista de Docentes .°.</div>
            <div class="modal-body" style="overflow:hidden;">
                ...
                <div class="form-control form-control-sm">
                    <div class="input-group input-group-sm my-1">
                        ...
                        <input id="d_paterno" onkeyup="buscardocente();" class="form-control">
                    </div>
                    <div class="input-group input-group-sm my-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Apellido Materno</span>
                        </div>
                        <input id="d_materno" onkeyup="buscardocente();" class="form-control">
                    </div>
                    <div class="input-group input-group-sm my-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Nombres</span>
                        </div>
                        <input id="d_nombres" onkeyup="buscardocente();" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-control form-control-sm my-1" style="border-width:5px;height:300px;overflow:auto;">
                    ...
                    <table class="table responsive table-sm table-hover border border-black m-0 table-bordered" style="font-size:13px;">
                        ...
                        <tbody id="contenidoDocente">
                            ...
                            $consulta = $funcion -> Seleccionar("SELECT cod_docente, paterno, materno, nombres FROM docente ORDER BY paterno, materno, nombres");
                            ...
                            while($fila = mysqli_fetch_array($consulta)){
                                ...
                                echo '
                                <tr ondblclick="seleccionarDocente('."'".$fila[0]."'".');" style="cursor:pointer;">
                                    <td class="text-center">'.$cont.'</td>
                                    <td class="text-center">'.$fila[0].'</td>
                                    <td>'.$fila[1].' '.$fila[2].', '.$fila[3].'</td>
                                </tr>
