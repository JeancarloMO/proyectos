...
<html lang="es">
    ...
    <head>
        ...
        ?>
        <link rel="stylesheet" href="procesos/docente.css">
        <script src="procesos/docente.js"></script>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-control form-control-sm">
                                ...
                                <div class="form-control form-control-sm my-1">
                                    <span class="font-weight-bold">DATOS DEL DOCENTE</span>
                                </div>

                                <div class="form-control form-control-sm centrar-custom my-1">
                                    <img src="<?php echo $ruta; ?>assets/img/docente.png" alt="" style="height:161px;">
                                </div>
                            ...
                            <div class="col-lg-8 form-control form-control-sm">
                                ...
                                <div class="form-control form-control-sm my-1">
                                    <span class="font-weight-bold">LISTA DE DOCENTES</span>
                                </div>
                                ...
                                <div class="form-control form-control-sm table-responsive my-1 p-1 border border-success rounded" style="max-height:403px">
                                    ...
                                    <table class="table table-light table-sm table-hover table-bordered m-0" style="font-size:13px;">
                                        ...
                                        <tbody id="contenidoDocente" class="text-dark">
                                            ...
                                            FROM docente ORDER BY paterno, materno, nombres");
