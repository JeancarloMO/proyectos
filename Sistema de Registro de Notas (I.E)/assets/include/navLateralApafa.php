        ...
        <div class="input-group input-group-sm">
            ...
            <form action="<?php echo $ruta; ?>inc.out/pdo.php" method="post" class="form-control p-0">
                <select name="pdo" id="pdo" class="form-control form-control-sm" onchange="this.form.submit()">
                    ...
                    $consulta = "SELECT DISTINCT M.periodo FROM apafa AS A INNER JOIN matricula AS M ON A.alumno = M.alumno WHERE A.apoderado = '".$_SESSION["fa_DOCUMENTO"]."' and M.periodo <> '".$_SESSION["fa_PERIODO"]."' ORDER BY M.periodo DESC";
