<div class="border-bottom border-warning uGreen" id="uHeader">
    <div class="uCentrarCustom" style="height:100%;">
        ...
        <img src="<?php echo $ruta; ?>assets/img/feyalegria.png" width="auto" height="100%" alt="" class="my-2 p-2">
        <div id="inst-menu" class="uCentrarCustom text-center">
            <div class="text-warning font-weight-bold">
                INSTITUCIÓN EDUCATIVA
                <br>
                <h6 class="font-weight-bold text-white m-0">FE Y ALEGRÍA</h6>
            </div>
        </div>
        <div class="centrar-custom" style="margin: 0px 20px 0px auto">
            <div>
                <span style="color: white">
                    <strong class="text-warning">Usuario: </strong><?php echo strtoupper($_SESSION['fa_TIPO_USUARIO']);?>
                </span>
            </div>
