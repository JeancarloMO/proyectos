            ...
            <div class="modal-body pb-0">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <span id="obs_docente" style="font-family: Century Gothic, CenturyGothic, AppleGothic, sans-serif;font-size: 15px;line-height: 15.4px;"></span>

                        <textarea name="" id="obs" cols="" rows="" class="w-100 p-2 border border-info rounded" style="max-height:185px;min-height:185px;font-family: Comic Sans MS, cursive, sans-serif;" readonly></textarea>
