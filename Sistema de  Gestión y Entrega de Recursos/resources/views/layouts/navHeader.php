<div class="border-bottom border-warning uGreen" id="uHeader">
    <div class="uCentrarCustom" style="height:100%;">
        ...
        <img id="" src="public/images/usdg.png" width="auto" height="100%" alt="" class="my-2 p-2">
        <div id="inst-menu" class="uCentrarCustom text-center">
            <div class="text-warning">
                UNIVERSIDAD SANTO DOMINGO DE GUZMAN
                <br>
                <h6 class="font-weight-bold text-white m-0">OFICINA DE GERENCIA Y LOGISTICA</h6>
            </div>
        </div>
        <div class="centrar-custom" style="margin: 0px 10px 0px auto">
            <div>
                <span style="color: white"><strong class="text-warning">Usuario: </strong><?php echo strtoupper($_SESSION['log_USUARIO']);?></span>
            </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer p-1 border-0 align-self-center">
                        <a href="salir" class="btn btn-primary p-1 m-1" style="width:65px;">Si</a>
